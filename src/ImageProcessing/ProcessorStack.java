...
public class ProcessorStack {
    ...
    private void incrementJob(){
        ...
        if(currentJob ==STACK.length)  currentJob =0;
        if(currentJob==end) System.out.println("Stack Full");
    }
    ...
    private void process(){
        while(true){
            try {Thread.sleep(PROCESSOR_DELAY);} catch(Exception e){};
            pop();
        }
    }
