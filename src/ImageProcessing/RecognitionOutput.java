...
/**
 * The purpose of this class is to create a common object which the
 * FormRecongition class returns to the instigating class, allowing the
 * instigating class to get a 'Real-time' update on the pixel formations
 * detected and the progress.
 *
 * @author mathew
 */
public class RecognitionOutput {
    ...
    double PROGRESS = 0.0;
    /**
     * This is the most up to date list of the chars detected at the time of
     * call
      *
     */
    ...
    private String getAdditional(int index) {
        for (AdditionalChar a : FORMATTING) {
            if (a.INDEX == index) {
                return a.ADDITION + "";
            }
        }
