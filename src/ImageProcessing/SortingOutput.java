...
/**
 * Similar to the Recognition Output, all of the pixel formations are published
 * to this as they are being discovered, so that the array list in this object
 * can be called in real time and an update of what has been found can be
 * displayed on a UI
 *
 * @author mathew
 */
