...
public class CropWindowController implements Initializable, SubControllerInterface {
    ...
    /**
     * Because the controller implements the use of initializable, when the FXML
     * file is loaded, this method is called in its corresponding controller, In
     * this implementation the CROP_PANEL is instantiated by passing in the
     * CROP_CANVAS, This creates a separate controller responsible, for drawing
     * the crop panel and governing mouse inputs. It also adds
     *
     * @param url
     * @param rb
     */
    ...
    /**
     * This adjusts the settings render parameters that the CROP_PANEL uses to
     * draw the image
     */
    public void render() {
    ...
    /**
     * This opens a file window allowing the user to pick and load a .jpg or
     * .png.
     *
    ...
    public void cancel() {
        ...
        if (POPUP != null) {
            ...
            System.out.println("Need to set popup inst.");
        }
    }
