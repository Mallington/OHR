...
/**
 * This particular data structure is used for storing the binary pixels used for
 * inputting into a network for training or evaluation. the structure is
 * polymorphic and allows for any object type to be handled
 *
 * @author 160471
 */
