...
public interface SubControllerInterface {
    ...
    /**
     * Allows parent to load an object which is then processed by the
     * controller.
     *
    ...
    /**
     * Allows parent to the background of the UI attached to the controller
     * implementing it.
     *
     * @param p
     */
    ...
    /**
     * Used by the SubWindowLoader or parent class to disclose the GUIs
     * containing window/ pop up instance
     *
     * @param popInst Containing window
     */
    /**
     * Discloses the pop up instance to the controller, so that it may have
     * control over it containing window functions.
     *
    ...
    /**
     *
     * @return Allows parent class to check if there is data to return, so that
     * it can dispose of the window or keep it open.
     */
